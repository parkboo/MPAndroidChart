 ...
 */
public class CustomBarHighlighter extends ChartHighlighter<CustomBarDataProvider> {

	public CustomBarHighlighter(CustomBarDataProvider chart) {
		super(chart);
	}
	...
	public Highlight getHighlight(float x, float y) {
		...
		if (h == null)
			...
			CustomBarDataSet set = mChart.getCustomBarData().getDataSetByIndex(h.getDataSetIndex());
	...
	protected int getXIndex(float x) {
		...
		if (!mChart.getCustomBarData().isGrouped()) {
	 ...
	 * @return
	 */
	protected Highlight getStackedHighlight(Highlight old, CustomBarDataSet set, int xIndex, int dataSetIndex, double yValue) {
	...
	protected float getBase(float x) {
		...
		int steps = (int) ((float) xVal / ((float) setCount + mChart.getCustomBarData().getGroupSpace()));

		float groupSpaceSum = mChart.getCustomBarData().getGroupSpace() * (float) steps;
