...
import com.github.mikephil.charting.highlight.CustomBarHighlighter;
...
import com.github.mikephil.charting.renderer.XAxisRendererCustomBarChart;
 ...
 */
public class CustomBarChart extends BarLineChartBase<CustomBarData> implements CustomBarDataProvider {
	...
	protected void init() {
		...
		mXAxisRenderer = new XAxisRendererCustomBarChart(mViewPortHandler, mXAxis, mLeftAxisTransformer, this);

		mHighlighter = new CustomBarHighlighter(this);
	...
	public RectF getBarBounds(BarEntry e) {
		...
		CustomBarDataSet set = mData.getDataSetForEntry(e);
