...
public class XAxisRendererCustomBarChart extends XAxisRenderer {

    protected CustomBarChart mChart;

    public XAxisRendererCustomBarChart(ViewPortHandler viewPortHandler, XAxis xAxis, Transformer trans,
