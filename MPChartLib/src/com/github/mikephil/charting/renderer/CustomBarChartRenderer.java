...
import com.github.mikephil.charting.data.CustomBarDataSet;
...
public class CustomBarChartRenderer extends DataRenderer {
    ...
    public void initBuffers() {
        ...
        CustomBarData barData = mChart.getCustomBarData();
        mBarBuffers = new BarBuffer[barData.getDataSetCount()];

        for (int i = 0; i < mBarBuffers.length; i++) {
            CustomBarDataSet set = barData.getDataSetByIndex(i);
    ...
    protected void drawDataSet(Canvas c, CustomBarDataSet dataSet, int index) {
    ...
    public void drawValues(Canvas c) {
        ...
        if (passesCheck()) {
            ...
            List<CustomBarDataSet> dataSets = mChart.getCustomBarData().getDataSets();
            ...
            for (int i = 0; i < mChart.getCustomBarData().getDataSetCount(); i++) {

                CustomBarDataSet dataSet = dataSets.get(i);
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        int setCount = mChart.getCustomBarData().getDataSetCount();
        ...
        for (int i = 0; i < indices.length; i++) {
            ...
            CustomBarDataSet set = mChart.getCustomBarData().getDataSetByIndex(dataSetIndex);
            ...
            if (index >= 0
                ...
                float groupspace = mChart.getCustomBarData().getGroupSpace();
    ...
    public float[] getTransformedValues(Transformer trans, List<BarEntry> entries,
            int dataSetIndex) {
        return trans.generateTransformedValuesCustomBarChart(entries, dataSetIndex,
                mChart.getCustomBarData(),
                mAnimator.getPhaseY());
    }

    protected boolean passesCheck() {
        return mChart.getCustomBarData().getYValCount() < mChart.getMaxVisibleCount()
